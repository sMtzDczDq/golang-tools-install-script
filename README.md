...
curl -L https://raw.githubusercontent.com/sMtzDczDq/golang-tools-install-script/master/goinstall.sh | bash
```
...
```shell
wget -q -O - https://raw.githubusercontent.com/sMtzDczDq/golang-tools-install-script/master/goinstall.sh | bash -s -- --version 1.18

# or...
curl -L https://raw.githubusercontent.com/sMtzDczDq/golang-tools-install-script/master/goinstall.sh | bash -s -- --version 1.18
```
...
```shell
wget -q -O - https://raw.githubusercontent.com/sMtzDczDq/golang-tools-install-script/master/goinstall.sh | bash -s -- --remove

# or...
curl -L https://raw.githubusercontent.com/sMtzDczDq/golang-tools-install-script/master/goinstall.sh | bash -s -- --remove
```
